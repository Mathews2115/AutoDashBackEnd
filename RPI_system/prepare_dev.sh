...
sudo chmod u+rw /home/one/AutoDashBackEnd/RPI_system/start_vcan.sh

# ccan socket server and web server setup
sudo cp /home/one/AutoDashBackEnd/RPI_system/services/vcan/vcan_server.service  /etc/systemd/system/
